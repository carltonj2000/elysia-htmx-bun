...
VALUES
    ...
    (
        'Healthy Eating',
        'Make nutritious choices and fuel your body.',
        '#00FF00'
    ),
    (
        'Reading',
        'Expand knowledge and stimulate the mind.',
        '#FFFF00'
    ),
    (
        'Journaling',
        'Reflect on experiences and express thoughts.',
        '#0000FF'
    ),
    (
    ...
    (
        ...
        'Nurture relationships and build connections.',
        '#800080'
    ),
    (
        'Getting enough sleep',
        'Rest and recharge for optimal functioning.',
        '#C0C0C0'
    ),
    (
        'Volunteering',
    ...
    (
        ...
        'Appreciate the good things in life and cultivate happiness.',
        '#FF8000'
    );